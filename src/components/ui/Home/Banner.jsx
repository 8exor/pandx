      ...
      <div className="pt-[96px] bg-[#edffe1]">
        <section className=" bg-[url('src/assets/images/BG_mask.svg')]  bg-no-repeat bg-bottom bg-cover pt-20 relative">
          <div className="absolute top-30 max-w-[400px]  md:left-10 sm:left-10 left-0">
            <img
              className="w-[90px] sm:w-[130px] md:w-[150px] lg:w-[200px] xl:w-[400px]"
          ...
          <div className="absolute bottom-[40%] max-w-[230px]  left-[25%]">
            <img
              className="w-0 sm:w-[130px] md:w-[100px] lg:w-[150px] xl:w-[250px]"
              src="/assets/images/Cloud01.svg"
              alt="img-cloud"
            />
          </div>
          <div className="absolute top-[20%] max-w-[200px] right-0">
            <img
              className="w-[70px] md:w-[100px] xl:w-[200px]"
          ...
          <div className="py-20 mycontainer">
            ...
            <div className="relative w-full max-w-[1200px] mx-auto">
              ...
              {/* Panda 1 */}
              <div
                className="absolute  top-[37%] md:top-[7%] lg:top-[8%] md:left-[1%] lg:left-[2%] left-[3%]  w-[23%] md:w-[25%] sm:w-[15%] lg:w-[22%]"
                data-aos="zoom-in"
              >
                <img
              ...
              {/* Panda 2 */}
              <div
                className="absolute top-[45%] sm:top-[22%]   lg:top-[20%] right-[36%] w-[14%] md:w-[12%] sm:w-[15%]"
                data-aos="zoom-in"
              >
                <img
              ...
              {/* Panda 3 */}
              <div
                className="absolute top-[14%]  md:-top-[11%] lg:-top-[20%] md:right-[8%] lg:right-[11%] right-[10%] w-[28%] md:w-[25%] sm:w-[18%]"
                data-aos="zoom-in"
              >
        ...
        <div className="mycontainer">
          <div className="grid grid-cols-1 md:grid-cols-2 py-6 sm:py-20 gap-8 items-center justify-between">
            <div
              ...
              data-aos="slide-up"
            >
              <h2 className="lg:text-[82px]  text-[40px] text-center lg:text-left sm:text-[40px] md:text-left  sm:leading-10 leading-20">
                About Us
              </h2>
            ...
            <div
              className="md:ml-auto mx-auto  animate__animated animate__zoomIn relative"
              data-aos="zoom-in"
            >
