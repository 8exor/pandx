...
export default function ReportPool() {
  ...
  return (
    <div className='bg-[#efffe3] border-2 border-[#5b5bac] rounded-md mt-15 p-7'>
     <div className='grid grid-cols-1 justify-between gap-10 items-center md:grid-cols-3 lg-grid-cols-4 lg:grid-cols-4 lg:grid-rows-3 '>
        {
            reportPool?.map((pool, i)=>(
                <div key={i} className='flex flex-col items-center bg-[#c4ffa1] p-2  border border-[#68a12b] rounded-md shadow-xl/30'>
     ...
     <div className=' flex items-center justify-between mt-10 py-2 flex-wrap gap-5'>
        ...
        <div className='border border-black p-2 px-3 flex items-center gap-2' onClick={()=>setPickDate(true)}>
