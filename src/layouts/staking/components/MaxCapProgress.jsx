  ...
  return (
    ...
    {maxCap &&  <p className="text-[16px] w-full text-center sm:text-[18px] 
      ...
      <div className={`${maxCap ? "w-full md:w-30" : "w-20"} h-4 rounded-full bg-[#26316A] overflow-hidden`}>
        <div
          className="h-full bg-gradient-to-r from-[#28DB8C] via-[#6AEA94] to-[#B8FC9D] rounded-full transition-all duration-[1500ms] ease-out text-center text-white text-xs"
          style={{ width}}
        >
          {percent && percent}
        </div>
